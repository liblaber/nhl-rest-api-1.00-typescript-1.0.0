 ...
 */
export const scheduleGameStatus = z.object({
...
/**
 *
 * @typedef  {ScheduleGameStatus} scheduleGameStatus
 * @property {string}
 * @property {string}
 * @property {string}
 * @property {string}
 * @property {boolean}
 */
export type ScheduleGameStatus = z.infer<typeof scheduleGameStatus>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const scheduleGameStatusResponse = z
  .object({
    abstractGameState: z.string().optional(),
    codedGameState: z.string().optional(),
    detailedState: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const scheduleGameStatusRequest = z
  .object({
